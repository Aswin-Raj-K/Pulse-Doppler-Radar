...
AUTOPILOT_ROOT := D:/Vivado2020/Xilinx/Vitis_HLS/2020.2
...
ifndef AP_GCC_PATH
  AP_GCC_PATH := D:/Vivado2020/Xilinx/Vitis_HLS/2020.2/tps/win64/msys64/mingw64/bin
endif
...
$(ObjDir)/radarProcessor_tb.cpp_pre.cpp.tb.o : radarProcessor_tb.cpp_pre.cpp.tb.cpp $(ObjDir)/.dir
	$(Echo) "   Compiling radarProcessor_tb.cpp_pre.cpp.tb.cpp" $(AVE_DIR_DLOG)
	$(Verb) $(CC) ${CCFLAG} ${TOOLCHAIN}  -fno-builtin-isinf -fno-builtin-isnan -c $(IFLAG) $(DFLAG) $< -o $@; \

$(ObjDir)/radarProcessor.cpp_pre.cpp.tb.o : radarProcessor.cpp_pre.cpp.tb.cpp $(ObjDir)/.dir
	$(Echo) "   Compiling radarProcessor.cpp_pre.cpp.tb.cpp" $(AVE_DIR_DLOG)
	$(Verb) $(CC) ${CCFLAG} ${TOOLCHAIN}  -fno-builtin-isinf -fno-builtin-isnan -c $(IFLAG) $(DFLAG) $< -o $@; \
