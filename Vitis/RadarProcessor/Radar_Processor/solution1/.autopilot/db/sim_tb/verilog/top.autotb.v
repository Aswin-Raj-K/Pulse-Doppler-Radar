...
`define AUTOTB_TVIN_data_IN  "./c.top.autotvin_data_IN.dat"
`define AUTOTB_TVIN_data_OUT  "./c.top.autotvin_data_OUT.dat"
`define AUTOTB_TVIN_data_IN_out_wrapc  "./rtl.top.autotvin_data_IN.dat"
`define AUTOTB_TVIN_data_OUT_out_wrapc  "./rtl.top.autotvin_data_OUT.dat"
`define AUTOTB_TVOUT_data_OUT  "./c.top.autotvout_data_OUT.dat"
`define AUTOTB_TVOUT_data_OUT_out_wrapc  "./impl_rtl.top.autotvout_data_OUT.dat"
module `AUTOTB_TOP;
...
initial begin : generate_AESL_ready_cnt_proc
    ...
    initial begin : finish_simulation
        ...
        @ (posedge AESL_clock);
        @ (posedge AESL_clock);
    fp1 = $fopen("./rtl.top.autotvout_data_OUT.dat", "r");
    fp2 = $fopen("./impl_rtl.top.autotvout_data_OUT.dat", "r");
    if(fp1 == 0)        // Failed to open file
        $display("Failed to open file \"./rtl.top.autotvout_data_OUT.dat\"!");
    else if(fp2 == 0)
        $display("Failed to open file \"./impl_rtl.top.autotvout_data_OUT.dat\"!");
    else begin
        $display("Comparing rtl.top.autotvout_data_OUT.dat with impl_rtl.top.autotvout_data_OUT.dat");
        post_check(fp1, fp2);
    end
    $fclose(fp1);
    $fclose(fp2);
...
begin
    ...
    `define STREAM_SIZE_OUT_data_OUT "./stream_size_out_data_OUT.dat"
