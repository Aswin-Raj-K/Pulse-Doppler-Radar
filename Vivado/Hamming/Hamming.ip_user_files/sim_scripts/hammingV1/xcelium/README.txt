...
#
# Generated by export_simulation on Sun Dec 12 14:24:30 +0530 2021
#
################################################################################
...
'-reset_run' switch to the './hammingV1.sh' script.

./hammingV1.sh -reset_run
...
./hammingV1.sh -noclean_files

For more information on the script, please type './hammingV1.sh -help'.
